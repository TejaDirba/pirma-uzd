    ...
    for (int j = 0; j < skaicius; j++) {
        ...
        while (!validChoice) {
            ...
            if (autoGenChoice == "taip") {
                int pazymiuKiekis = rand() % 10 + 1;  // Generate a random number of grades between 1 and 10
                for (int k = 0; k < pazymiuKiekis; k++) {
                    int pazymys = rand() % 10 + 1;  // Random grade between 1 and 10
        ...
        int egzaminas;
        if (autoGenChoice == "taip") {
            egzaminas = rand() % 10 + 1;  // Random exam grade between 1 and 10
        }
        else {
